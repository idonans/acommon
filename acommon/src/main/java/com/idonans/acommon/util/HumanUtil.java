...
public class HumanUtil {
    ...
    public static String getHumanSizeFromByte(long bytes) {
        ...
        if (bytesAbs > _80P_GB) {
            return String.format("%.1fGB", 1.0f * bytes / GB);
        }
        if (bytesAbs > _80P_MB) {
            return String.format("%.1fMB", 1.0f * bytes / MB);
        }
        if (bytesAbs > _80P_KB) {
            return String.format("%.1fKB", 1.0f * bytes / KB);
        }
        return String.format("%.1fB", 1.0f * bytes);
    }
